...
export default function CalendarPage() {
  ...
  useEffect(() => {
    router.prefetch("/agenda/configurar-agenda")
  }, [router]);

  return (
    <>
      <div className="flex flex-col w-full h-full gap-8 overflow-x-hidden px-5 pt-5 pb-6">
        <div className="flex flex-col items-center w-full min-h-[269.52px] bg-customBlue-400 rounded-[29.75px] gap-7 px-[16.23px] pt-9">
          <div className="flex flex-col gap-6 font-poppins font-semibold text-customNeutral-50">
