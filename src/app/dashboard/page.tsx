...
export default function DashboardPage() {
  ...
  return (
    <>
      <div className="flex flex-col w-full gap-8 overflow-x-hidden px-5 pt-5 pb-6">
        ...
        <div className="w-full h-42 items-center justify-center bg-customBlue-400 rounded-3xl ">
          <div className="w-[90%] max-w-md h-42 bg-customBlue-400 rounded-3xl mx-auto px-6 py-5 flex items-center justify-between">
        ...
        <div className="flex flex-col gap-4 relative">
          ...
          <div className="flex flex-row gap-5">
            <div className="flex flex-col w-full justify-between gap-5 z-10">
              <div className="flex flex-col h-25 border border-customBlue-400 bg-[#FFFFFF] rounded-[20px] relative">
              ...
              <div className="flex w-full h-[195px] bg-[#F0F9FF] rounded-[22px] p-4 relative overflow-hidden">
            ...
            <div className="flex flex-col gap-5">
              <div className="flex flex-col w-full h-[195px] bg-[#FFE9E9] rounded-[22px] px-5 py-2 relative overflow-hidden">
              ...
              <div className="flex flex-col justify-center items-center w-37 h-25 bg-[#1D1D1D] rounded-[20px] font-inter text-[#FFFFFF]">
        ...
        <div className="flex mx-auto gap-15">
          <svg width={24} height={24} fill="currentColor"><use href="/icons/blueHome.svg" /></svg>
          <svg width={24} height={24} fill="currentColor"><use href="/icons/calendar.svg" /></svg>
          <svg width={24} height={24} fill="currentColor"><use href="/icons/report.svg" /></svg>
          <svg width={24} height={24} fill="currentColor"><use href="/icons/user.svg" /></svg>
        </div>
